...
public class DeleteArmyDialog implements DialogInterface.OnClickListener {

    private final Context context;
    private final Dialog dialog;
    private OnDeleteListener listener;

    public DeleteArmyDialog(Context context) {
    ...
    public void onClick(DialogInterface dialogInterface, int which) {
        ...
        if (which == DialogInterface.BUTTON_POSITIVE) {
            ...
            Toast.makeText(context, context.getString(R.string.error_deletion_canceled), Toast.LENGTH_SHORT).show();
            dialog.cancel();
            if (listener != null) {
                listener.onOperationCanceled();
            }
        }
    }

    public DeleteArmyDialog setListener(OnDeleteListener listener) {
